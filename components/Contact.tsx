      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <a
              href="https://github.com/zasasamar2129"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-4 p-6 bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl hover:bg-[var(--primary)]/10 hover:border-[var(--primary)] transition-all group"
            >
            ...
            <a
              href="mailto:zasasamar@outlook.com"
              className="flex items-center justify-center gap-4 p-6 bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl hover:bg-[var(--primary)]/10 hover:border-[var(--primary)] transition-all group"
            >
          ...
          <motion.button
            onClick={() => window.location.href = "mailto:zasasamar@outlook.com"}
